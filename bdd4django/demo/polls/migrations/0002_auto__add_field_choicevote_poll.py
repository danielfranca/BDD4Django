...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChoiceVote.poll'
        db.add_column('polls_choicevote', 'poll',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['polls.Poll']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChoiceVote.poll'
        db.delete_column('polls_choicevote', 'poll_id')
